...
Usage:
  python experiments/score_variance.py --type event
  python experiments/score_variance.py --type person
  python experiments/score_variance.py --type all
"""
...
def process_type(entity_type: str) -> dict:
    ...
    # --- Global averages of per-entity means and variances ---
